...
class FloorPlanAreaSubtaskPinSerializer(BaseModelSerializer):
    class Meta:
        ...
        expandable_fields = {
            ...
            'expanded_subtask': ('api.http.serializers.subtask.subtask_serializer.SubtaskSerializer', {'source': 'content_object'}),
            'expanded_object_id': ('api.http.serializers.subtask.subtask_serializer.SubtaskSerializer', {'source': 'content_object'}),
