...
from api.models import Task, LocationMatrix, User, Package
...
class TaskListSerializer(BaseModelSerializer):
    ...
    location_matrix = serializers.SerializerMethodField(method_name='get_location_matrix_for_list')
    ...
    building = serializers.CharField(read_only=True, max_length=255, allow_null=True)
    level = serializers.CharField(read_only=True, max_length=255, allow_null=True)
    area = serializers.CharField(read_only=True, max_length=255, allow_null=True)

    def get_location_matrix_for_list(self, obj: Task):
        return {
            'id': obj.location_matrix_id,
