...
from api.models import FloorPlan, Subtask, FloorPlanArea
from api.permissions import IsSuperuser, IsCompanyAdmin, IsProjectSubcontractor, IsProjectAdmin, IsProjectManager
...
class FloorPlanSubtaskViewSet(BaseViewSet, ListModelMixin):
    _request_permissions = {
        'list': (IsAuthenticated, (IsSuperuser | IsCompanyAdmin | IsProjectAdmin | IsProjectManager | IsProjectSubcontractor | CanClientSeeProjectSubtasks),),
    }
    ...
    def list(self, request, *args, **kwargs):
        ...
        subquery = subtask_filter.filter_queryset(Subtask.objects.add_filters_for_floor_plan_subquery())
