...
from api.models import Recipient, Package, User


class TaskUpdateRecipientsFilter(rest_framework.FilterSet):
    ...
    building = CharInFilter(
        field_name='taskupdate__task__location_matrix__building',
        widget=QueryArrayWidget
    )
    area = CharInFilter(
        field_name='taskupdate__task__location_matrix__area',
        widget=QueryArrayWidget
    )
    level = CharInFilter(
        field_name='taskupdate__task__location_matrix__level',
        widget=QueryArrayWidget
    )
    package = rest_framework.ModelMultipleChoiceFilter(
        field_name='taskupdate__task__package_activity__packagematrix__package',
        widget=QueryArrayWidget,
